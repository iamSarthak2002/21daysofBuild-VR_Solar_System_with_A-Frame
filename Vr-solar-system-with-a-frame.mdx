...
Under the same directory as your **index.html** file, create a new **planet_textures/** folder. Next, you can find the texture files for our system [here](https://github.com/iamSarthak2002/21daysofBuild-VR_Solar_System_with_A-Frame/tree/main/Planet_textures). Go ahead and download each file and add them to your **planet_textures/** folder.
...
- [GitHub repository for this project](https://github.com/iamSarthak2002/21daysofBuild-VR_Solar_System_with_A-Frame/tree/main)
